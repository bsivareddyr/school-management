...
@Component({
  ...
  styles: [`
    ...
    .intro-card { background: #fff; border-radius: 16px; padding: 32px; margin-top: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); }
    .intro-card h1 { margin: 0 0 4px; color: #1a237e; font-size: 28px; }
    ...
    .info-label { display: block; font-size: 11px; color: #888; text-transform: uppercase; }
    .info-value { display: block; font-size: 15px; font-weight: 600; color: #333; }
    ...
    .instructions li { font-size: 14px; color: #555; margin-bottom: 4px; }
    .btn-start { width: 100%; padding: 14px; background: #1a237e; color: #fff; border: none; border-radius: 10px; font-size: 16px; font-weight: 700; cursor: pointer; transition: background 0.2s; }
    .btn-start:hover { background: #283593; }
    .no-questions { text-align: center; color: #999; font-style: italic; padding: 20px; }

    .exam-container { display: flex; flex-direction: column; gap: 16px; }
    .exam-header { background: #fff; border-radius: 12px; padding: 16px 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); }
    .exam-title { display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; }
    .exam-title h2 { margin: 0; color: #1a237e; font-size: 18px; }
    .question-counter { font-size: 14px; color: #666; font-weight: 500; }
    ...
    .answered-count { font-size: 12px; color: #888; margin-top: 4px; display: inline-block; }
    .exam-progress { }

    .exam-body { display: grid; grid-template-columns: 1fr 240px; gap: 16px; }
    .question-panel { }
    .question-card { background: #fff; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); margin-bottom: 16px; }
    .question-header { display: flex; align-items: center; gap: 10px; margin-bottom: 16px; }
    .q-number { background: #1a237e; color: #fff; padding: 4px 12px; border-radius: 16px; font-size: 13px; font-weight: 600; }
    .q-marks { background: #e8f5e9; color: #2e7d32; padding: 4px 10px; border-radius: 16px; font-size: 12px; font-weight: 500; }
    .q-type { padding: 4px 10px; border-radius: 16px; font-size: 12px; font-weight: 500; }
    .q-type.mcq { background: #e3f2fd; color: #1565c0; }
    .q-type.short_answer { background: #f3e5f5; color: #7b1fa2; }
    .question-text { font-size: 16px; color: #333; line-height: 1.6; margin: 0; }
    ...
    .option-letter { width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; border-radius: 50%; background: #f5f5f5; font-weight: 600; font-size: 13px; color: #666; flex-shrink: 0; }
    .option-item.selected .option-letter { background: #1a237e; color: #fff; }
    ...
    .short-answer textarea:focus { outline: none; border-color: #1a237e; }

    .question-nav { display: flex; justify-content: space-between; gap: 12px; }
    .btn-nav { padding: 10px 24px; border: 1px solid #ddd; border-radius: 8px; background: #fff; cursor: pointer; font-size: 14px; font-weight: 500; }
    .btn-nav:disabled { opacity: 0.4; cursor: not-allowed; }
    .btn-nav:not(:disabled):hover { background: #f5f5f5; }
    .btn-next { background: #1a237e; color: #fff; border-color: #1a237e; }
    .btn-next:hover { background: #283593 !important; }
    .btn-submit { padding: 10px 24px; background: #2e7d32; color: #fff; border: none; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; }
    .btn-submit:hover { background: #388e3c; }

    .question-palette { background: #fff; border-radius: 12px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); height: fit-content; position: sticky; top: 16px; }
    .question-palette h3 { margin: 0 0 12px; font-size: 14px; color: #1a237e; }
    .palette-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 8px; margin-bottom: 16px; }
    .palette-btn { width: 36px; height: 36px; border: 2px solid #e0e0e0; border-radius: 8px; background: #fff; cursor: pointer; font-weight: 600; font-size: 13px; color: #666; transition: all 0.2s; }
    .palette-btn.current { border-color: #1a237e; background: #e8eaf6; color: #1a237e; }
    .palette-btn.answered { background: #e8f5e9; border-color: #66bb6a; color: #2e7d32; }
    .palette-btn.answered.current { border-color: #1a237e; }
    ...
    .dot.current { border-color: #1a237e; background: #e8eaf6; }
    .dot.answered { border-color: #66bb6a; background: #e8f5e9; }
    .dot.unanswered { }
    .btn-submit-side { width: 100%; padding: 10px; background: #2e7d32; color: #fff; border: none; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; }
    .btn-submit-side:hover { background: #388e3c; }

    .already-submitted { text-align: center; max-width: 500px; margin: 40px auto; background: #fff; border-radius: 16px; padding: 40px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); }
    .submitted-icon { font-size: 48px; margin-bottom: 12px; }
    .already-submitted h2 { color: #1a237e; margin: 0 0 8px; }
    .already-submitted p { color: #666; margin: 0 0 24px; }
    ...
    .result-label { display: block; font-size: 11px; color: #888; text-transform: uppercase; margin-bottom: 4px; }
    ...
    .btn-secondary { background: #fff; color: #1a237e; padding: 10px 20px; border: 1px solid #1a237e; border-radius: 8px; text-decoration: none; font-weight: 600; }
